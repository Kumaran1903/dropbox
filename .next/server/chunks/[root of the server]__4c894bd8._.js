...
"[project]/.next-internal/server/app/api/get-files/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/get-files/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"])();
        ...
        const { Contents } = await s3.send(new __TURBOPACK__imported__module__$5b$externals$5d2f40$aws$2d$sdk$2f$client$2d$s3__$5b$external$5d$__$2840$aws$2d$sdk$2f$client$2d$s3$2c$__cjs$29$__["ListObjectsV2Command"](params));
        if (!Contents) {
            return Response.json({
                files: []
            }, {
        ...
        const files = await Promise.all(Contents.map(async (file)=>{
            ...
            const signedUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$s3$2d$request$2d$presigner$2f$dist$2d$es$2f$getSignedUrl$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSignedUrl"])(s3, command, {
                expiresIn: 60
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__4c894bd8._.js.map